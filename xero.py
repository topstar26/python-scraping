...
for i in range(3): 
    source = requests.get('https://www.xero.com/uk/advisors/find-advisors/?type=advisors&orderBy=ADVISOR_RELEVANCE&sort=ASC&location=53.39990299999999,-2.3000968999999714,53.5445879,-2.14682879999998&pageNumber=' + str(i+1) + '&place-name=Manchester,%20UK&country=GB&view=list').text
